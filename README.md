...
This preprocessor runs in Cypress's own version of Node. If you require npm packages or your own code into the [background file](https://on.cypress.io/background-process), they need to be compatible with [the version of Node that Cypress uses]((https://github.com/cypress-io/cypress/blob/develop/.node-version)).
